...
// Site URL for V4V payment filtering (required via env)
const SITE_URL = process.env.V4V_SITE_URL;
if (!SITE_URL) {
  console.error('Error: V4V_SITE_URL environment variable is required');
  process.exit(1);
}
